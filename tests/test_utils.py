...
from src.utils import filtration_by_experience, followup_actions
...
def test_filtration_by_experience(mock_manager, mock_vacancies, capsys):
    ...
    with patch("builtins.input", side_effect=["2"]), patch("src.utils.followup_actions") as mock_followup:
